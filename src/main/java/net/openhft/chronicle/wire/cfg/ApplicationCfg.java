...
public class ApplicationCfg implements MapInstallable {
    ...
    @Nullable
    @Override
    public Void install(String path, @NotNull Map<String, Object> assetTree) throws Exception {
        LOGGER.info("Building Engine " + assetTree);
        for (@NotNull Map.Entry<String, MapInstallable> entry : installableMap.entrySet()) {
        ...
        for (@NotNull Consumer<Map<String, Object>> consumer : toInstall) {
